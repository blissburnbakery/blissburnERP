...
function initAuthEngine() {
    ...
    const ROLE_PERMISSIONS = {
        admin: ["dashboard", "pos", "production", "inventory", "b2b", "invoices", "accounts", "reports", "settings"],
        production: ["production", "inventory", "settings"],
        sales: ["pos", "b2b", "invoices", "settings"],
        delivery: ["b2b"],
        accountant: ["dashboard", "invoices", "accounts", "reports", "settings"]
    };
